...
**3D モデルビューア : https://niart120.github.io/spss_draw/**

`docs/` に `<model-viewer>` ベースの 3D モデルビューアを配置している。  
本ツールで生成した STL モデルをブラウザ上で回転・ズームして確認でき、iPhone / iPad では AR Quick Look で実寸 AR プレビューも可能。
